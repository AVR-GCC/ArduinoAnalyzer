...
/* --- GLOBAL VARIABLES --- */
static int32_t g_2 = 0xB2C21353L;
static int32_t g_9 = 0x58BD4DFBL;
static int32_t g_19[1][3] = {{3L,3L,3L}};
static int32_t * volatile g_27 = &g_19[0][2];/* VOLATILE GLOBAL g_27 */
...
{ /* block id: 0 */
    int16_t l_12 = (-1L);
    int32_t l_20 = 0xEE72C34CL;
    int32_t * volatile *l_30 = (void*)0;
    int32_t * volatile **l_29 = &l_30;
lbl_28:
    for (g_2 = 0; (g_2 > (-27)); g_2 -= 8)
    { /* block id: 3 */
        uint32_t l_21 = 1UL;
        int32_t *l_24 = &g_2;
        if ((-(int32_t)0x02526041L))
        { /* block id: 4 */
            int32_t *l_6 = (void*)0;
            int32_t *l_7 = (void*)0;
            int32_t *l_8 = &g_9;
