...
static volatile int32_t g_3 = 0x7C7CE53DL;
static int32_t g_4[8] = {0xB4074DD0L,(-1L),0xB4074DD0L,0xB4074DD0L,(-1L),0xB4074DD0L,0xB4074DD0L,(-1L)};
static int32_t g_12[5][5] = {{0x8108531DL,0x8108531DL,0x8108531DL,0x8108531DL,0x8108531DL},{0x9598AAF0L,0x9598AAF0L,0x9598AAF0L,0x9598AAF0L,0x9598AAF0L},{0x8108531DL,0x8108531DL,0x8108531DL,0x8108531DL,0x8108531DL},{0x9598AAF0L,0x9598AAF0L,0x9598AAF0L,0x9598AAF0L,0x9598AAF0L},{0x8108531DL,0x8108531DL,0x8108531DL,0x8108531DL,0x8108531DL}};
static int32_t g_14 = 0L;
static int32_t g_16 = 0x1C5A3D7FL;
static uint32_t g_17 = 0x6B42BE19L;
static int32_t * volatile g_34 = &g_4[3];



static int8_t func_1(void);
static int8_t func_18(int32_t p_19, int32_t * p_20, int32_t p_21, uint32_t p_22, int32_t * p_23);
static int8_t func_1(void)
{
    uint32_t l_10 = 0x266D210EL;
    int32_t l_30 = 0x5ADF6F6DL;
    int16_t l_41 = 0L;
    int32_t l_42 = 0x1F882D77L;
    int32_t l_43 = 0xFDB9CE08L;
    int32_t l_44 = 0x45FE6EE0L;
    int16_t l_46[8][8] = {{(-1L),8L,(-1L),1L,0L,0x35D5L,0L,0x35D5L},{0xD4A0L,1L,(-6L),1L,0xD4A0L,1L,(-1L),8L},{0L,1L,(-1L),8L,(-1L),1L,0L,0x35D5L},{(-6L),0x35D5L,(-1L),0L,0xD4A0L,0L,(-1L),0x35D5L},{(-1L),(-1L),0L,8L,0xD4A0L,0x35D5L,0xD4A0L,8L},{(-6L),(-1L),(-6L),0x35D5L,(-1L),0L,0xD4A0L,0L},{0L,0x35D5L,0L,0x35D5L,0L,1L,(-1L),8L},{0L,1L,(-1L),8L,(-1L),1L,0L,0x35D5L}};
    int32_t l_48 = 0xD0A3AFD5L;
    int32_t l_49[7][5] = {{0xAD64B6C7L,0x0A8DCCB6L,0x5F91B207L,0L,0xB4242223L},{0xBC9AF00AL,0L,5L,0L,0xBC9AF00AL},{0x08467E5FL,0xA5B3E5B6L,(-9L),0L,0L},{0x319DC099L,0x08467E5FL,0x69F8C36BL,0L,0xC62902D2L},{5L,(-9L),0L,0xA5B3E5B6L,0L},{0L,0L,0L,0x69F8C36BL,0xBC9AF00AL},{0L,(-9L),0xBC9AF00AL,0x5F91B207L,0xB4242223L}};
    uint8_t l_61 = 0xCAL;
    int i, j;
    for (g_4[3] = 0; (g_4[3] > 26); g_4[3] += 4)
    {
        int16_t l_9[6][8] = {{0xE17BL,0x720BL,(-1L),0x720BL,0xE17BL,(-2L),(-1L),(-1L)},{0xD724L,1L,0x720BL,0xD6B6L,(-6L),(-6L),0xD6B6L,0x720BL},{(-1L),(-1L),0x720BL,(-7L),0xCF41L,(-8L),(-1L),0xD724L},{(-6L),(-1L),(-1L),(-1L),(-1L),(-1L),(-6L),0xD724L},{(-1L),(-8L),0xCF41L,(-7L),0x720BL,(-1L),(-1L),0x720BL},{0xD6B6L,(-6L),(-6L),0xD6B6L,0x720BL,1L,0xD724L,(-1L)}};
        ...
        g_17 &= ((*l_13) = ((*l_11) |= (((int32_t)l_9[2][3] + (int32_t)l_10) | g_3)));
    }
    if ((func_18((g_4[3] <= l_10), &g_16, g_12[1][3], g_2, &g_12[1][3]) , l_30))
    {
        int16_t l_31 = 0L;
        int32_t *l_32 = (void*)0;
        int32_t *l_33 = (void*)0;
        ...
        else
        {
            ...
            for (i = 0; i < 8; i++)
                l_36[i] = &g_16;
            g_16 &= func_18((func_18(g_12[4][4], l_35, (*g_34), g_17, l_33) != g_12[1][2]), &g_4[3], l_30, (*l_35), l_32);
        }
    }
    else
    {
        int16_t l_45 = 1L;
        int32_t l_47[8][6] = {{(-1L),7L,(-1L),(-1L),7L,(-1L)},{(-1L),7L,(-1L),(-1L),7L,(-1L)},{(-1L),7L,(-1L),(-1L),7L,(-1L)},{(-1L),7L,(-1L),(-1L),7L,(-1L)},{(-1L),7L,(-1L),(-1L),7L,(-1L)},{(-1L),7L,(-1L),(-1L),7L,(-1L)},{(-1L),7L,(-1L),(-1L),7L,(-1L)},{(-1L),7L,(-1L),(-1L),7L,(-1L)}};
        int i, j;
        for (g_14 = 0; (g_14 <= 4); g_14 += 1)
        {
            int32_t *l_37 = &g_16;
            int32_t *l_38 = &g_12[2][3];
            int32_t *l_39 = &g_4[7];
            int32_t *l_40[6] = {&g_12[1][3],&g_12[1][3],&g_12[1][3],&g_12[1][3],&g_12[1][3],&g_12[1][3]};
            uint8_t l_50[3][3];
            int i, j;
            for (i = 0; i < 3; i++)
            {
        ...
        for (l_42 = 0; (l_42 != 17); l_42++)
        {
            ...
            for (i = 0; i < 2; i++)
                l_55[i] = 4294967295UL;
            l_55[1]++;
            (*l_60) &= ((uint8_t)((g_2 == g_4[3]) >= 0x8105A18AL) - (uint8_t)g_17);
        }
    }
    return l_61;
}
...
static int8_t func_18(int32_t p_19, int32_t * p_20, int32_t p_21, uint32_t p_22, int32_t * p_23)
{
    int32_t *l_24[5][6] = {{&g_4[3],&g_14,&g_14,&g_4[3],&g_4[3],&g_12[1][3]},{&g_12[1][3],&g_12[1][3],&g_4[3],&g_14,&g_12[0][3],&g_14},{&g_16,&g_12[1][3],&g_16,&g_12[1][3],&g_4[3],&g_4[3]},{&g_14,&g_16,&g_16,&g_14,&g_12[1][3],&g_14},{&g_14,&g_14,&g_4[3],&g_14,&g_14,&g_12[1][3]}};
    uint32_t l_25 = 0x77F0A061L;
    int32_t **l_29 = (void*)0;
    int32_t ***l_28 = &l_29;
    int i, j;
    l_25--;
