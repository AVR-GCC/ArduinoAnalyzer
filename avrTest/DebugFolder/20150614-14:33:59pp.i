...
static int32_t g_8 = 0x86BD085CL;
static int32_t * volatile g_7 = &g_8;
...
static uint16_t func_1(void)
{
    uint32_t l_6[5] = {18446744073709551611UL,18446744073709551611UL,18446744073709551611UL,18446744073709551611UL,18446744073709551611UL};
    int16_t l_9 = 0x8BFCL;
    int i;
    (*g_7) ^= ((int8_t)((int8_t)(-7L) - (int8_t)5UL) >> (int8_t)l_6[3]);
    return l_9;
}
