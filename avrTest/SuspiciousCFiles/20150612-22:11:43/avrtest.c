...
static uint8_t  func_5(uint32_t  p_6, uint32_t  p_7, uint32_t  p_8, uint16_t  p_9);
...
{ /* block id: 0 */
    ...
    { /* block id: 3 */
        int32_t l_10 = 0xFC3938DDL;
        (*g_16) &= (((func_5(l_10, l_10, l_10, l_10) < 0xE1L) != g_2) <= l_10);
    }
    return g_2;
}
